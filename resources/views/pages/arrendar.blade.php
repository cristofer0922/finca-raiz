...
<section style="padding-top:140px" class="bg-dark text-white pb-4">
    <div class="container text-center">
        <h1 class="serif" data-aos="fade-up">Arrienda con <span class="gold">Confianza</span></h1>
        <p class="text-muted">Propiedades verificadas y asesoría profesional</p>
    </div>
</section>
<div class="container my-5">
    ...
    <div class="form-card mt-5" data-aos="fade-up">
        <h3 class="serif text-center mb-4">Solicita tu arriendo</h3>
        <form method="POST" action="{{ route('solicitud.store') }}" class="row g-3">@csrf
            <input type="hidden" name="tipo_solicitud" value="arriendo">
            ...
            <div class="col-md-6"><label>Fecha</label><input class="form-control" type="date" name="fecha"></div>
